...
class DenseUNet(object):
    def __init__(self, decodeImgShape=(320, 560, 1), outputShape=(320, 280, 1), numClasses=2,
                 ...
                 use_dice_loss=False, use_batch_norm=False, lambda_one=1.0, name='DenseUNet'):
    ...
    def _init_test_graph(self):
        ...
        # Batch for test data
        self.imgTests, self.seg_GT, self.img_name_test, self.user_id_test = testReader.batch(multi_test=self.multi_test,
